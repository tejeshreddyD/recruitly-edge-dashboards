...
import { fetchUserPlannerCalendarEvents } from "@api/dashboardDataApi.js";
...
const PlannerCalendarEvents = ({type = "TODAY",date = 0, viewType="FULL_DAY",eventType="EVENT"}) => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    { field: "organiser.name", headerName: "Organiser By" },
  ...
  const onGridReady = useCallback((params) => {
    ...
    fetchUserPlannerCalendarEvents({start_date:start_date,end_date:end_date,type:eventType});
