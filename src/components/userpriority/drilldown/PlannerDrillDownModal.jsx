...
const PlannerDrillDownModal = ({modalVisible = false, type="TODAY", date=0, filterType="ALL", onDetailViewClose}) => {
  ...
  return (<Modal
    ...
    >
      {loading ? (
        ...
        <PlannerDrillDownData type={type} date={date} filterType={filterType} />
      )}
    </Modal>
  )
}
